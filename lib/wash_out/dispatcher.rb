module WashOut
  ...
  module Dispatcher
    ...
    def _map_soap_parameters
      Rails.logger.warn("wash_out:dispatcher -- Request ENV:\n#{request.env.keys}")
      Rails.logger.warn("wash_out:dispatcher -- soap_action:\n#{request.env['wash_out.soap_action']}")
      Rails.logger.warn("wash_out:dispatcher -- SOAP Data:\n#{xml_data}")
    ...
    def _generate_wsdl
      ...
      @wsp_policy = soap_config.wsp_policy
    ...
    def xml_data
      ...
      return xml_data if soap_config.wsdl_style.to_s == "document"
